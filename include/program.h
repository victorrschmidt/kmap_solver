...
// Program running
#define INPUT_FILE_NAME         "notation.in"
#define OUTPUT_FILE_NAME        "result.out"
...
// Program messages
#define DEFAULT_MAX_VARIABLE_AMOUNT_EXCEEDED_ERROR_MESSAGE    "Fatal error: Too much accepted variables."
...
#define DEFAULT_MEMORY_ALLOCATION_ERROR_MESSAGE               "Error: Memory allocation error."
...
#define DEFAULT_REPEATED_VARIABLE_ERROR_MESSAGE               "Error: Invalid product expression.\nRepeated variable on product."
...
#define DEFAULT_COMPLETE_KMAP_MESSAGE                         "The expression is true for all cases.\n"
